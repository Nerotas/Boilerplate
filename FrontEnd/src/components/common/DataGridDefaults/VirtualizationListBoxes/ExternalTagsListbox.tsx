...
export const ExternalProductsListbox = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLElement>>(function ExternalProductsListbox(
    props,
    ref
) {
