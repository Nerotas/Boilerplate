...
function renderRow({ data, index, style }: ListChildComponentProps) {
    ...
    return (
        <Typography component="li" key={key} {...optionProps} noWrap px={2} style={inlineStyle}>
            {option.productName} ({option.productSectionName})
        </Typography>
    );
}
...
export const ProductSectionListbox = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLElement>>(function ProductSectionListbox(props, ref) {
